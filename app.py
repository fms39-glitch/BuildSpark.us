...
import os, re, logging, sqlite3, json
...
def send_notification_email(lead_id, name, email, phone,
    ...
    notify  = os.getenv("NOTIFY_EMAIL", "buildspark.agency@gmail.com")
...
<body><div class="wrap">
  ...
  <div class="footer">
    <p>BuildSpark &nbsp;|&nbsp; Newark, NJ &nbsp;|&nbsp; +1 (973) 368-3440</p>
  </div>
</div></body></html>"""
        msg = Message(
        ...
        mail.send(msg)
        logger.info(f"Notification email sent → {notify}")
...
<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;
  ...
  <p style="font-size:13px;color:#64748b;">
    Questions? Email us or WhatsApp:<br/>
  ...
  <p style="font-size:12px;color:#334155;">
    — Faizan Shaikh, Founder @ BuildSpark | Newark, NJ
        ...
        mail.send(msg)
        logger.info(f"Confirmation email sent → {email}")
    except Exception as exc:
        logger.error(f"Confirmation email failed: {exc}")
